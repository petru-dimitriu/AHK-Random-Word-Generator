...
Gui, 12: Add, Text, x6 y10 w360 h65 , Each symbol represents a possible letter or letter group. Each letter or group has three associated frequencies - one sets how frequent the element will appear at the beggining at the word, the second one represents frequency in the middle of the word, and the third one represents frequency at the end of the word.
...
AddSymbol:
  ...
  If !ErrorLevel
      If StrLen(WrittenSymbol)>1
        {
          MsgBox,16,Error,Symbols must be one single character.
          Return
        }
      Else
...
Gui, 99: Add, Text, x56 y13 w230 h118 , Are you sure you want to remove this symbol and also all the letters/groupings it may conain? This opperation cannot be undone. Also`, you may keep a copy of it in order to use it later. To do this`, click Export.
